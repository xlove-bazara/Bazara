// Brevo Transactional Email Service for Automated Order Confirmations
export async function sendOrderDeliveryEmail({
            ...
            <table width="100%" max-width="600" cellpadding="0" cellspacing="0" style="max-width: 600px; background-color: #121626; border-radius: 20px; border: 1px solid rgba(255,255,255,0.1); overflow: hidden; box-shadow: 0 20px 40px rgba(0,0,0,0.5);">
              ...
              <tr>
                <td style="padding: 20px 30px; text-align: center;">
                  ...
                  <p style="margin: 0; font-size: 14px; color: #cbd5e1; line-height: 1.6;">
                    Your enrollment in <strong>${productTitle}</strong> is complete. Your Google Drive digital vault is ready for instant lifetime access.
                  </p>
                </td>
              </tr>
                ...
                <td style="padding: 0 30px 20px 30px;">
                  <table width="100%" cellpadding="12" cellspacing="0" style="background-color: #090c14; border-radius: 12px; border: 1px solid rgba(255,255,255,0.06); font-size: 13px;">
                    ...
                    <tr>
                      ...
                      <td align="right" style="color: #10b981; font-family: monospace; font-weight: 700; border-top: 1px solid rgba(255,255,255,0.05);">${orderId}</td>
                    </tr>
                    <tr>
                      <td style="color: #64748b; font-weight: 600; border-top: 1px solid rgba(255,255,255,0.05);">Amount Paid:</td>
                      <td align="right" style="color: #ffffff; font-weight: 800; border-top: 1px solid rgba(255,255,255,0.05);">₹${amount}</td>
                    </tr>
                    <tr>
              ...
              <tr>
                <td style="padding: 20px 30px; background-color: #0a0d16; border-top: 1px solid rgba(255,255,255,0.08); font-size: 12px; color: #94a3b8; line-height: 1.6;">
                  ...
                  4. Need support? Reply directly to this email or WhatsApp us at +91 98765 43210.
                </td>
              </tr>
  ...
  try {
    ...
    console.log('Brevo Order Confirmation Email Response:', data);
    return { success: response.ok, data };
  } catch (err) {
    console.warn('Error sending Brevo order email:', err);
