          ...
          <form onSubmit={handleVerifyOtp} className="space-y-4 text-left">
            ...
            <div>
              ...
              <input
                ...
                placeholder="123456"
                className="w-full px-3.5 py-3 rounded-xl bg-white/[0.05] border border-white/10 text-white text-center tracking-[0.5em] text-lg font-mono focus:outline-none focus:border-emerald-400"
                required
                autoFocus={otpSent}
              />
            </div>
            ...
            <button
              type="submit"
              disabled={loadingAuth || !otpSent || otpInput.length < 6}
