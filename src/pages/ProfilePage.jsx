...
export default function ProfilePage({ 
  ...
  return (
    <div className="min-h-screen pb-28 md:pb-16 bg-transparent text-slate-100 selection:bg-emerald-500/30">
      {/* Top Header */}
      <header className="sticky top-0 z-30 px-4 md:px-8 py-3.5 backdrop-blur-2xl bg-[#091017]/80 border-b border-white/[0.08]">
