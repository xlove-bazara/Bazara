...
export const defaultSiteSettings = {
  marquee_announcements: [
    "⚡ FLASH SALE LIVE: GET UP TO 90% OFF ON ALL VIRAL BUNDLES",
    "📁 1-SECOND INSTANT GOOGLE DRIVE ACCESS AFTER CHECKOUT",
    "⭐ 25,000+ ACTIVE CREATORS & AGENCIES TRUST BAZARA.IN",
    "♾️ LIFETIME COMMERCIAL RESELL RIGHTS (PLR) INCLUDED",
    "🚀 NO WATERMARKS • 4K 60FPS QUALITY • READY TO POST"
  ],
